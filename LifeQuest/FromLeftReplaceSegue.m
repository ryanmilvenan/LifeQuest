...
#import "FromLeftReplaceSegue.h"

@implementation FromLeftReplaceSegue
...
-(void)perform{
    ...
    [self performSelector:@selector(animationDone:) withObject:dst afterDelay:0.17899];
}
